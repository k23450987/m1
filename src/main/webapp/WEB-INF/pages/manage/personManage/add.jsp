...
<script>
		$(function(){
			$("#btn_ok").bind('click',function(){
				...
				if(job_==null){
					$.post("personAdd.action", { 'p_name': p_name, 'age': age, 'info': info},
				   function(data){
				     	$('#p2').window('close');
				...
				$.post("personAdd.action", { 'p_name': p_name, 'age': age, 'info': info, 'dept_id': job_.dept_id, 'job_id': job_.job_id },
				   function(data){
				     	$('#p2').window('close');
                 		$('#dg_2').datagrid('reload');
				   });
	...
	<div class="easyui-panel" style="width:400px" data-options="fit:true">
	    ...
	    <form id="ff" method="post">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>员工姓名:</td>
	    			<td><input class="easyui-textbox" type="text" name="p_name" id="pname" data-options="required:true"></input></td>
	    		</tr>
	    		<tr>
	    			<td>员工年龄:</td>
	    		...
	    		<tr>
	    			<td>员工信息:</td>
	    			<td><input class="easyui-textbox" name="info" id="info" data-options="multiline:true" style="height:60px"></input></td>
	    		</tr>
