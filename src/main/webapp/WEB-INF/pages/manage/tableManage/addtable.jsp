        ...
        $(function () {
            ...
            $("#add").bind('click', function () {
                ...
                $("#table tbody").append("<tr id =" + tr_id + "><td><input type='hidden' name='id' value='" + tr_id
                        + "' /></td><td><input type='text' name='params' id='add_titleName' /></td><td><select name='type'><option value='int'>整数</option><option value='varchar'>字符串</option></select></td><td><input type='checkbox' name='unique' value='true'></td><td><input type='button' value='删除该行' onclick='func_rowdel(this)'></td></tr>");
