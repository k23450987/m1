...
<script type="text/javascript">
	$(function(){
		...
		$("#add").bind('click', function() {
				tr_id++;
				$("#table tbody").append("<tr id ="+tr_id+"><td><input type='hidden' name='id' value='"+tr_id+"' /></td><td><input type='text' name='params' id='add_titleName' /></td><td><select name='type'><option value='int'>整数</option><option value='varchar'>字符串</option></select></td><td><input type='button' value='删除该行' onclick='func_rowdel(this)'></td></tr>");
	...
	<form id="form" action="#">
		<table style="padding: 10px;width: 300px" id="table">
			...
			<c:forEach items="${cols }" var="col">
				...
				<tr>
					<td><input type="hidden" name="colid" value="${col.colid }">
					</td>
