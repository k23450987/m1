    ...
    <script type="text/javascript">
        $(function () {
                ...
                onClick: function (node) {
                    ...
                    $("#dg").datagrid({
                        ...
                        toolbar: [{
                            ...
                            handler: function () {
                                ...
                                $('#p').window({
                                    ...
                                    title: '编辑岗位',
                                    closable: true,
                                    href: "jobToUpdate.action?job_id=" + job.id,
                                    modal: true
                                });
                        ...
                        onClickRow: function () {
                            ...
                            var job = $('#dg').datagrid('getSelected');
                            $("#dg_2").datagrid({
                                url: 'personListJson.action?jobId=' + job.id,
                                width: 500,
                                ...
                                toolbar: [{
                                    ...
                                    handler: function () {
                                        ...
                                        $('#p3').window({
                                            ...
                                            title: '编辑岗位',
                                            closable: true,
                                            href: "personToUpdate.action?person_id=" + person.id,
                                            modal: true
                                        });
                                    }
                                }]
            ...
            $('#alljob').bind('click', function () {
                ...
                $("#dg").datagrid({
                    ...
                    onClickRow: function () {
                        ...
                        var job = $('#dg').datagrid('getSelected');
                        $("#dg_2").datagrid({
                            url: 'personListJson.action?job_id=' + job.id,
                            width: 500,
                            columns: [[{
                                field: 'checkbox',
                                checkbox: "true"
            ...
            $('#win3deptdel').bind('click', function () {
                $.get("deptDel.action", {
                    'dept_id': $('#eudg4').datagrid('getSelected').id
                }, function (result) {
                    if (result) {
            ...
            $('#win3deptedit').bind('click', function () {
                ...
                $('#p4').window({
                    ...
                    left: 500,
                    top: 200,
                    href: 'deptToUpdate.action?dept_id=' + $('#eudg4').datagrid('getSelected').id,
                    modal: true
                });
            });
...
<div class="easyui-panel" style="width:230px;padding:5px">
    <div>
        部门管理<br/> <span>
			<a id="deptaddbtn" href="javascript:void(0)" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-add'">添加</a> </span><span>
			<a id="deptdelbtn" href="javascript:void(0)" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-remove'">删除</a> </span><span>
			<a id="depteditbtn" href="javascript:void(0)" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-edit'">编辑</a> </span><span>
			<a id="reload" href="javascript:void(0)" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-reload'">刷新</a> </span><br>
...
<div id="win3" style="display: none;" title="所有部门">
    <div id="tb">
        <a id="win3deptdel" href="javascript:void(0)" class="easyui-linkbutton"
           data-options="iconCls:'icon-remove'">删除</a>
        <a id="win3deptedit" href="javascript:void(0)" class="easyui-linkbutton"
           data-options="iconCls:'icon-edit'">修改</a>
        <a id="win3reload" href="javascript:void(0)" class="easyui-linkbutton"
    ...
    <table id="eudg4" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th data-options="field:'parentName',width:100">父部门</th>
        </tr>
        </thead>
    </table>
</div>

<div id="dg_2div" style="position: absolute;left: 900px;top:0px;padding:5px;">
